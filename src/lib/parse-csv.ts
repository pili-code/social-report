...
const COLUMN_MAP: Record<string, Record<string, string>> = {
  ...
  linkedin_dianne_posts: {
    ...
    post_url: "post_url", "post url": "post_url",
    topic_tag: "topic_tag", "topic tag": "topic_tag",
    content_note: "content_note", "content note": "content_note",
    members_reached: "members_reached", "members reached": "members_reached",
    social_engagements: "social_engagements", "social engagements": "social_engagements",
    engagement_rate: "engagement_rate", "engagement rate": "engagement_rate",
    reactions: "reactions", comments: "comments", reposts: "reposts",
    saves: "saves", followers: "followers", sends: "sends",
    link_engagements: "link_engagements", "link engagements": "link_engagements",
    premium_button_engagements: "premium_button_engagements",
    "premium custom button engagements": "premium_button_engagements",
    note: "note",
